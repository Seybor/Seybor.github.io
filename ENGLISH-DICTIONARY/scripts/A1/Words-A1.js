let v = [
  ...
  { en: 'accent', ru: 'акцент, ударение / (исчисляемое)', tr: '[ˈæksᵊnt]' },
  ...
  { en: 'maybe', ru: 'возможно', tr: '[ˈmeɪbi]' },
  ...
  { en: 'no one', ru: 'никто', tr: '[nəʊ] [wʌn]' },
  { en: 'nobody', ru: 'никто', tr: '[ˈnəʊbədi]' },
  ...
  { en: 'perhaps', ru: 'возможно', tr: '[pəˈhæps]' },
  ...
  { en: 'quite', ru: 'довольно', tr: '[kwaɪt]' },
  { en: 'rainy', ru: 'дождливый', tr: '[ˈreɪni]' },
  { en: 'rarely', ru: 'редко', tr: '[ˈreəli]' },
  { en: 'rather', ru: 'довольно', tr: '[ˈrɑːðə]' },
  ...
  { en: 'success', ru: 'успех / исчисляемое', tr: '[səkˈses]' },
  ...
  { en: 'tall', ru: 'высокий(в контексте роста)', tr: '[tɔːl]' },
  { en: 'tax', ru: 'налог', tr: '[tæks]' },
  { en: 'thief', ru: 'вор(воры', tr: '[θiːf]' },
