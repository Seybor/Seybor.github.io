const MAIN_ARRAY = [
  ...
  {
    ru: 'Я знаю, что носители языка говорят очень быстро',
  ...
  {
    ru: 'Ему нужно чуть-чуть поспать',
    en: 'He needs to sleep a bit',
  },
  {
  ...
  },
  {
    ...
    en: 'Time passes very fast/quickly',
  },
  {
...
// const randomNumber = (min = 0, max = MAIN_ARRAY.length - 1) => {
//   return Math.floor(Math.random() * (max - min + 1) + min);
// };

// for (let i = 0; i <= randomNumber(); i++) {
//   console.log(MAIN_ARRAY[i].en + ' - ' + MAIN_ARRAY[i].ru);
// }
