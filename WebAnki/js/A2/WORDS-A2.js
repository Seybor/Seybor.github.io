const WORDS_A2_1_5 = [
	...
	{ en: 'excited', ru: 'в восторге', tr: '[ɪkˈsaɪtɪd]' },
	{ en: 'generation', ru: 'поколение', tr: '[ˌʤɛnəˈreɪʃᵊn]' },
	{ en: 'mess', ru: 'беспорядок', tr: '[mɛs]' },
	{ en: 'obviously', ru: 'очевидно', tr: '[ˈɒbviəsli]' },

	{ en: 'nightlife', ru: 'ночная жизнь', tr: '[ˈnaɪtlaɪf]' },
	{ en: 'nature', ru: 'природа', tr: '[ˈneɪʧə]' },
	...
	{ en: 'advantage', ru: 'преимущество', tr: '[ədˈvɑːntɪʤ]' },
	{
		en: 'attitude [to]',
		ru: 'отношение [к чему-то]',
		tr: '[ˈætɪtjuːd] [[tuː]]'
	},
	{ en: 'blackboard', ru: 'классная доска', tr: '[ˈblækbɔːd]' },
