let verb = [
	...
	{
		ru: 'убить',
		en: ['kill', 'murder', 'assassinate', 'execute', 'slaughter', 'put down'],
		desc: [
			'kill - общий термин',
	...
	},
	{
		...
		desc: ['like - общий термин', 'enjoy - наслаждаться', 'love - любить', 'appreciate - ценить'],
		ex: [
	...
	},
	{
		ru: 'останавливаться',
		en: ['stop ', 'stay'],
		desc: ['stop - если просто куда-то шли и остановились', 'stay - пишется в значении погостить'],
		ex: [
	...
	},
	{
		ru: 'запрещать',
		en: ['prohibit', 'forbit'],
		desc: ['prohibit - более формальной термин ', 'forbit - более общий и может использоваться в разных вариантах '],
		ex: [
	...
	{
		ru: 'менять',
		en: ['change', 'alter', 'modify', 'convert', 'vary', 'shift', 'transform'],
		desc: [
	...
	{
		ru: 'победить',
		en: ['win', 'defead', 'beat', 'conquer', 'overcome', 'triumph', 'thrash'],
		desc: [
	...
	{
		ru: 'думать',
		en: ['think', 'assume', 'reason', 'conclude', 'work out', 'figure out'],
		desc: [
			'think - общий термин',
			'assume - предполагать',
			'reason - рассуждать',
