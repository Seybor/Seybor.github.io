const REGULAR = [
  ...
  [
    ...
    },
    {
      ...
      en_example: 'When will confirm our meeting?'
    },
    {
      en: 'to consider',
      tr: '[kənˈsɪdə]',
  ...
  [
    {
      ...
      tr: '[ɪɡˈzɪst]',
      ru: 'существовать',
      ru_example: 'Большинство людей чувствуют, что Бог действительно существуют',
  ...
  [
    {
      ...
      ru_example: 'Я не могу представить свои жизнь без спорта',
    ...
    },
    {
      ...
      ru_example: '1)Я буду скучать по тебе <br> 2)Я пропустил этот фильм <br> 3)Я упустил этот шанс',
